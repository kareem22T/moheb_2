    ...
    <div class="card-body">
        <div>
            ...
            <div  class="d-flex justify-content-between gap-4 align-items-end flex-wrap-wrap">
                ...
                <button type="submit" class="btn btn-primary w-50 form-control" style="height: fit-content" @click="getContentTranslations().then(() => { save(main_name, term_translations, title_translations, content_translations, thumbnail, sounds_translations, cat_id, tags)})">Save</button>
            </div>
        </div>
    </div>
    @else
