...
<div class="card w-100" id="Tag_prev">
    <div class="card-header d-flex justify-content-between gap-3">
        ...
        <a href="/Moheb/admin/tags/add" class="btn btn-primary w-fit d-flex gap-2 align-items-center">
...
createApp({
    ...
    methods: {
        async update(tag_id, tag_name) {
            ...
            try {
                const response = await axios.post(`/Moheb/admin/tags/edit`, {
                    tag_id: tag_id,
                    tag_name: tag_name,
                },
                );
        ...
        async deleteTag(tag_id) {
            $('.loader').fadeIn().css('display', 'flex')
            try {
                const response = await axios.post(`/Moheb/admin/tags/delete`, {
                    tag_id: tag_id,
                },
                );
                if (response.data.status === true) {
        ...
        async getTags() {
            $('.loader').fadeIn().css('display', 'flex')
            try {
                const response = await axios.post(`/Moheb/admin/tags?page=${this.page}`, {
                },
                );
                if (response.data.status === true) {
                    $('.loader').fadeOut()
        ...
        async getSearch(search_words) {
            try {
                const response = await axios.post(`/Moheb/admin/tags/search?page=${this.page}`, {
