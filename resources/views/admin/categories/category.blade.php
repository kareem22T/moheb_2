...
<div class="d-flex gap-2 justify-content-between mb-3">
    ...
    <div class="img card p-2" style="max-height: 150px; max-width: 140px">
        <img src="{{$category->thumbnail_path ? '/dashboard/images/uploads/categories_thumbnail/' . $category->thumbnail_path : '/dashboard/images/add_image.svg' }}" id="preview" alt="img logo" style="width: 100%; max-width: 100%;object-fit: contain;height: 100%;">                                                
    </div>
</div>
@endif
                ...
                <tr>
                    ...
                    <td class="border-bottom-0">
                        <div class="d-flex gap-2">
                            <a href="/Moheb/admin/categories/edit/{{ $cat->id }}" class="btn btn-secondary p-2"><h4 class="ti ti-edit text-light m-0 fw-semibold"></h4></a>
...
createApp({
    ...
    methods: {
        ...
        async getSearch(search_words) {
            try {
                const response = await axios.post(`/Moheb/admin/categories/search`, {
