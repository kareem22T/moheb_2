            ...
            <div class="pop-up show-images-pop-up card" v-if="showImages" style="min-width: 90vw;height: 90vh;padding: 20px;display: flex;flex-direction: column;justify-content: space-between;gap: 1rem;">
                ...
                <div class="foot" style="display: flex;width: 100%;justify-content: space-between;gap: 1rem;">
                    ...
                    <div class="d-flex gap-2">
                        <button class="btn btn-light"  @click="this.showImages = false">Cancel</button>
            ...
            <div class="mb-3 w-100 d-flex gap-3">
                ...
                <div class="w-75">
                    ...
                    <div  class="d-flex justify-content-between gap-4 align-items-end flex-wrap-wrap">
                        <button type="submit" class="btn btn-primary w-50 form-control" style="height: fit-content" @click="getContentTranslations().then(() => { save(main_name, Article_translations, title_translations, content_translations, thumbnail, sounds_translations, cat_id, tags)})">Save</button>
                    </div>
                </div>
            </div>
  ...
  methods: {
    ...
    async getImages() {
        ...
        try {
            ...
            if (response.data.status === true) {
                $('.loader').fadeOut()
                this.articles_images = response.data.data.data
            } else {
                $('.loader').fadeOut()
                document.getElementById('errors').innerHTML = ''
                $.each(response.data.errors, function (key, value) {
