    ...
    <div class="container">
        <form @submit.prevent>
            ...
            <div class="input">
                ...
                <img src="{{ asset('/public/site/imgs/envelope-regular.svg') }}" alt="email icon">
            </div>
            <div class="input">
                <input type="text" name="phone" id="phone" placeholder="Phone Number" v-model="phone">
                <img src="{{ asset('/public/site/imgs/phone-solid.svg') }}" alt="phone icon">
            </div>
            <div class="input">
                ...
                <img src="{{ asset('/public/site/imgs/calendar-days-regular.svg') }}" alt="calendar icon">
            </div>
            <div class="input">
